...
import { storeListar as loadUrl } from "../../api/asistencia/personaEquipo.api";
...
const AdministracionPersonaBuscarFilter = (props) => {
  const { intl, selectionMode } = props;
  //console.log("AdministracionPersonaBuscarFilter|props:",props);
  ...
  const renderFormContentCustomFilter = ({ getInstance }) => {
    return (
      ...
      // <GroupItem colCount={10} colSpan={10} labelLocation="top">
      <GroupItem colCount={14} colSpan={14} labelLocation="top">
        ...
        <GroupItem itemType="group" colSpan={3}>
          ...
          <div style={{ zIndex: +100, position: 'fixed', height: "83px", marginTop: "0px", marginLeft: "16px" }}>
            <Button
...
AdministracionPersonaBuscarFilter.propTypes = {
  showButton: PropTypes.bool,
  selectionMode: PropTypes.string,
  uniqueId: PropTypes.string,
};
AdministracionPersonaBuscarFilter.defaultProps = {
  showButton: true,
  selectionMode: "row", //['multiple', 'row']
  uniqueId: "AdministracionPersonasBuscar",
};
export default injectIntl(AdministracionPersonaBuscarFilter);
