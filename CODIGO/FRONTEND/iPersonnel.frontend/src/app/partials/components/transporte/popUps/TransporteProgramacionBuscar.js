...
const TransporteProgramacionBuscar = (props) => {

    const { selectionMode, intl, IdRuta } = props;
    const initialFilter = { Activo: "S", FechaProgramacionFormateada: '', FlInicioDesdeActual: 'S' };
        ...
        return (
            ...
            >
                ...
                <Column
                    ...
                    caption={intl.formatMessage({ id: "TRANSPORTE.PROGRAMMING.TYPE" })}
                    allowHeaderFiltering={false}
                    allowSorting={true}
                />
                ...
                <Column
                    dataField="FechaProgramacionFormateada"
                    caption={intl.formatMessage({ id: "TRANSPORTE.PROGRAMMING.DATE" })}
                    allowHeaderFiltering={false}
                    allowSorting={true}
                />
            </DataGrid>
    ...
    return (
        <>
            <Popup
                ...
                height={"600px"}
                width={"600px"}
                title={(intl.formatMessage({ id: "ACTION.SEARCH" }) + " " + intl.formatMessage({ id: "CONFIG.MENU.TRANSPORTE.PROGRAMACIÓN" })).toUpperCase()}
                onHiding={() =>
                    props.showPopup.setisVisiblePopUp(!props.showPopup.isVisiblePopUp)
                }
            >
                <Portlet>
                    ...
                    <CustomDataGrid
                        ...
                        initialLoadOptions={{ currentPage: 1, pageSize: 15, sort: { column: "IdParadero", order: "asc" }, }}
                        filterRowSize="sm"
...
TransporteProgramacionBuscar.propTypes = {
...
TransporteProgramacionBuscar.defaultProps = {
    showButton: false,
...
export default injectIntl(TransporteProgramacionBuscar);
