...
import { storeListar as loadUrl } from "../../../../api/transporte/rutaParadero.api";

import ArrayStore from "devextreme/data/array_store";
import DataSource from "devextreme/data/data_source";

const TransporteParaderosBuscar = (props) => {
    ...
    const renderDataGrid = ({ gridRef, dataSource }) => {
        return (
            ...
            >
                ...
                <Column
                dataField="Paradero"
                caption={intl.formatMessage({ id: "TRANSPORTE.WHEREABOUTS" })}
                allowHeaderFiltering={false}
                allowSorting={true}
                />
            </DataGrid>
    ...
    return (
        <>
            <Popup
                ...
                height={"600px"}
                width={"600px"}
                title={( intl.formatMessage({ id: "ACTION.SEARCH" }) +" "+ intl.formatMessage({ id: "TRANSPORTE.WHEREABOUTS" })).toUpperCase()} 
                onHiding={() =>
                    props.showPopup.setisVisiblePopUp(!props.showPopup.isVisiblePopUp)
                }
            >
...
TransporteParaderosBuscar.propTypes = {
...
TransporteParaderosBuscar.defaultProps = {
    showButton: false,
    selectionMode: "row", //['multiple', 'row','single]
    uniqueId: "TransporteParaderosBuscar",
    IdCompaniaMandante: "",
    IdEntidad: ""
};

export default injectIntl(TransporteParaderosBuscar);
