...
import { storeListarVehiculos as loadUrl } from "../../../../api/transporte/manifiesto.api";

import ArrayStore from "devextreme/data/array_store";
import DataSource from "devextreme/data/data_source";

const TransporteVehiculosBuscar = (props) => {
    ...
    return (
        <>
            <Popup
                ...
                height={"600px"}
                width={"600px"}
                title={( intl.formatMessage({ id: "ACTION.SEARCH" }) +" "+ intl.formatMessage({ id: "CONFIG.MENU.ACCESO.VEHICULOS" })).toUpperCase()} 
                onHiding={() =>
            ...
            >
                <Portlet>
                    ...
                    <CustomDataGrid
                        ...
                        initialLoadOptions={{currentPage: 1,pageSize: 15,sort: { column: "TipoVehiculo", order: "asc" },}}
                        filterRowSize="sm"
...
TransporteVehiculosBuscar.propTypes = {
...
TransporteVehiculosBuscar.defaultProps = {
    showButton: false,
...
export default injectIntl(TransporteVehiculosBuscar);
