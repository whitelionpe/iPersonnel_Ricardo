...
import { storeListar as loadUrl } from "../../api/administracion/contratoDivision.api";
...
const AdministracionContratoDivisonBuscar = (props) => {
  ...
  // initialFilter.IdCompaniaMandante = IdCompaniaMandante;
  // initialFilter.IdCompaniaContratista = IdCompaniaContratista;
  ...
  useEffect(() => {
    if (props.filtro) {
      const { IdCompaniaMandante, IdCompaniaContratista } = props.filtro;
      dataSource.loadDataWithFilter({ data: { IdCompaniaMandante, IdCompaniaContratista } });
    }
  }, [props.filtro]);
    ...
    return (
      ...
      >
        ...
        <Column
          ...
          width={"30%"} allowHeaderFiltering={false}
          allowSorting={true}
          alignment={"left"}
        />
        <Column
    ...
    <>
      <Popup
        ...
        title={(
          ...
          " " +
          intl.formatMessage({ id: "ADMINISTRATION.CONTRATO.DIVISION" })
        ).toUpperCase()}
        onHiding={() =>
          props.showPopup.setisVisiblePopUp(!props.showPopup.isVisiblePopUp)
        }
        ...
        <Portlet>
          ...
          <CustomDataGrid
            ...
            initialLoadOptions={{
              currentPage: 1,
              pageSize: 15,
              sort: { column: "Division", order: "asc" },
            }}
            filterRowSize="sm"
...
AdministracionContratoDivisonBuscar.propTypes = {
  showButton: PropTypes.bool,
  selectionMode: PropTypes.string,
  uniqueId: PropTypes.string,
};
AdministracionContratoDivisonBuscar.defaultProps = {
  showButton: false,
  selectionMode: "row", //['multiple', 'row','single]
  uniqueId: "administracionContratoDivision",
};
export default injectIntl(AdministracionContratoDivisonBuscar);
