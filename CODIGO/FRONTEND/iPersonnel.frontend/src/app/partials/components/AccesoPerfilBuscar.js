...
const AccesoPerfilBuscar = props => {
  const { intl } = props;
  ...
  return (
    <>
      <Popup
        ...
        height={"600px"}
        width={"600px"}
        title={(intl.formatMessage({ id: "ACTION.SEARCH" }) + ' ' + intl.formatMessage({ id: "ACCESS.PERSON.PROFILES" })).toUpperCase()}
      ...
      >
        <Portlet>
          ...
          >
            ...
            <Column dataField="IdPerfil" caption={intl.formatMessage({ id: "COMMON.CODE" })} editorOptions={false} allowEditing={false} visible={true} />
...
AccesoPerfilBuscar.propTypes = {
  showButton: PropTypes.bool,
  selectionMode: PropTypes.string,
};
AccesoPerfilBuscar.defaultProps = {
  showButton: true,
  selectionMode: "row", //['multiple', 'row','single]

};
export default injectIntl(AccesoPerfilBuscar);
