        ...
        <Fragment>
            <div style={styleConteiner} className="container">
                <div className="row">
                                ...
                                <>
                                    ...
                                    <div className="avatar-edit" style={{ marginTop: "38px" }}>
                                        ...
                                        >
                                            ...
                                            <img alt="SuperPlasma 50" width="150" src={toAbsoluteUrl("/media/users/fotoMedida.jpg")} /><br />
                    ...
                    {/* <div style={orientation === "V" ? null : { position: "absolute", botton: "50px" }} className={`col-${orientation === "V" ? "3" : "12"} content-imginfo`} > */}
                    { mostrarDimensiones &&
                        <div style={orientation === "V" ? null : { position: "absolute", botton: "50px" }} className={`content-imginfo`} >
                            <h6 className="h1-imageviewer" >
                                {intl.formatMessage({ id: "COMMON.HEIGHT" })}<b>{`${Math.round(imageSize.height)}px`}</b>
                            </h6>
                            <h6 className="h1-imageviewer" >
                                {intl.formatMessage({ id: "COMMON.WIDTH" })}<b>{`${Math.round(imageSize.width)}px`}</b>
                            </h6>
                        </div>
                    }
                </div>
