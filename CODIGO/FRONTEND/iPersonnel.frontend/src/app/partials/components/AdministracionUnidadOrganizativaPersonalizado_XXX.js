...
const AdministracionUnidadOrganizativaPersonalizado_XXX = props => {
  ...
  const hidePopover = () => {
    ...
    props.setModoEdicionTabs(false);
  }
...
AdministracionUnidadOrganizativaPersonalizado_XXX.propTypes = {
  showButton: PropTypes.bool,
  selectionMode: PropTypes.string,
  uniqueId: PropTypes.string,
  contratista: PropTypes.string
};
AdministracionUnidadOrganizativaPersonalizado_XXX.defaultProps = {
  showButton: false,
  selectionMode: "row",
...
export default injectIntl(AdministracionUnidadOrganizativaPersonalizado_XXX);
