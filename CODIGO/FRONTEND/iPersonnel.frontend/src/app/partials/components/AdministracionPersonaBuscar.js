...
const AdministracionPersonaBuscar = (props) => {
      ...
      <GroupItem colCount={14} colSpan={14} labelLocation="top">
        <GroupItem itemType="group" colCount={11} colSpan={11} >
          ...
          <Item
            ...
            isRequired={false}
            editorOptions={{
              items: [{ valor: "S", descripcion: intl.formatMessage({ id: "ACCESS.EXONERATION.ACTIVE" }) }, { valor: "N", descripcion: intl.formatMessage({ id: "COMMON.INACTIVE" }) }],
              valueExpr: "valor",
...
AdministracionPersonaBuscar.propTypes = {
...
AdministracionPersonaBuscar.defaultProps = {
  showButton: true,
...
export default injectIntl(AdministracionPersonaBuscar);
