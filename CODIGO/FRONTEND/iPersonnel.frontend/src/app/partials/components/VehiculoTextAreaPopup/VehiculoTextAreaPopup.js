...
import './VehiculoTextAreaPopup.css';

const VehiculoTextAreaPopup = ({
  ...
  return (
    <Popup
      ...
      title={(
        ...
        " " +
        intl.formatMessage({ id: "ADMINISTRATION.VEHICLE.MAINTENANCE" })
      ).toUpperCase()}
    ...
    >
      <div className="container">
        <div className="row div_body_popup cls_popup_item">
          <div className="col-10">
            ...
            {/* <div className="dx-field">
              <div className="dx-field-label">{intl.formatMessage({ id: "ADMINISTRATION.PERSON.DOCUMENT.TYPE" })}:</div>
        ...
        <div className="row">
          {/* <div className="col-12 reserva_detalle_titulo div_header_popup">
                        <span>Carga de Personas</span>
                    </div> */}
        </div>
        ...
        <div className="row">
          <div className="col-12">
            <TextArea
              height={300}
              placeholder={intl.formatMessage({ id: "ACCESS.PERSON.MARK.PLATE" })}
              spellcheck={false}
              maxLength={8000}
              //value={datosPersona}
...
export default injectIntl(VehiculoTextAreaPopup);
