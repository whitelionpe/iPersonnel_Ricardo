...
const AdministracionCompaniaMandanteBuscar = (props) => {
  const { intl, contratista, selectionMode, IdDivision } = props;
...
AdministracionCompaniaMandanteBuscar.propTypes = {
...
AdministracionCompaniaMandanteBuscar.defaultProps = {
  showButton: false,
...
export default injectIntl(AdministracionCompaniaMandanteBuscar);
