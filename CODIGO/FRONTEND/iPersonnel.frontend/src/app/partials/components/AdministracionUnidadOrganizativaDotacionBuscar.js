...
const AdministracionUnidadOrganizativaDotacionBuscar = props => {
...
AdministracionUnidadOrganizativaDotacionBuscar.propTypes = {
  showButton: PropTypes.bool,
  selectionMode: PropTypes.string,
  showCheckBoxesModes: PropTypes.string

};
AdministracionUnidadOrganizativaDotacionBuscar.defaultProps = {
  showButton: true,
  selectionMode: "row", //['multiple', 'row'] 
  showCheckBoxesModes: "none" //
};

export default injectIntl(AdministracionUnidadOrganizativaDotacionBuscar);
