...
const RestriccionListPage = props => {
    ...
    return (
        <>
            ...
            <PortletBody>
                <DataGrid
                    dataSource={props.restricciones}
                    showBorders={true}
                ...
                >
                    ...
                    <Column dataField="IdRestriccion" caption={intl.formatMessage({ id: "COMMON.CODE" })} width={"20%"} alignment={"center"} />
                    <Column dataField="Restriccion" caption={intl.formatMessage({ id: "ACCESS.RESTRICTION" })} width={"70%"} />
...
export default injectIntl(RestriccionListPage);
