...
import { listarTipoMarcacion, listarModoMarcacion } from "../../../../../_metronic/utils/utils";

import { useStylesEncabezado } from "../../../../store/config/Styles";
import AppBar from "@material-ui/core/AppBar";
import Toolbar from "@material-ui/core/Toolbar";
import Typography from "@material-ui/core/Typography";
// import VehiculoPersonaBuscarPage from "./VehiculoPersonaBuscarPage";
            ...
            <GroupItem colCount={4} >
              ...
              <Item colSpan={4}>
                <AppBar position="static" className={classesEncabezado.secundario}>
                  <Toolbar variant="dense" className={classesEncabezado.toolbar}>
                    <Typography variant="h6" color="inherit" className={classesEncabezado.title}>
                      {intl.formatMessage({ id: "ACCESS.VEHICLE.MARK.DRIVERDETAIL" })}
                    </Typography>
                  </Toolbar>
                </AppBar>
              </Item>
              ...
              <Item
                dataField="ChoferDocumento"
                isRequired={false}
                label={{
                  text: props.dataRowEditNew.ChoferTipoDocumento,
                }}
              ...
              <Item
                ...
                isRequired={false}
                label={{
                  text: intl.formatMessage({ id: "ACCESS.VEHICLE.COMPANY" }),
                }}
                colSpan={3}
                editorOptions={{
                  inputAttr: { style: "text-transform: uppercase" },
...
export default injectIntl(VehiculoMarcacionEditPage);
