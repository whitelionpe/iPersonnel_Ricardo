...
const VehiculoAccesoGrupoListPage = props => {
                ...
                <React.Fragment>
                    <Form>
                        <GroupItem>
                            <Item>
                                <DataGrid
                                    dataSource={props.vehiculoGrupos}
                                    showBorders={true}
...
VehiculoAccesoGrupoListPage.propTypes = {
    showHeaderInformation: PropTypes.bool,
};
VehiculoAccesoGrupoListPage.defaultProps = {
    showHeaderInformation: true,
};
export default injectIntl(VehiculoAccesoGrupoListPage);
