...
import PermanenciaTrabajdorFilterPage from "./PermanenciaVehiculoFilterPage";
import { dateFormat, isNotEmpty, getStartAndEndOfMonthByDay } from "../../../../../../_metronic";
import PermanenciaVehiculoListPage from "./PermanenciaVehiculoListPage";
...
const PermanenciaVehiculoIndexPage = (props) => {
  ...
  const exportReport = async () => {
    ...
    if (dataGridRef.current.props.dataSource._items.length > 0) {
      ...
      await serviceReporte.exportarExcelVehiculoPermanencia(params).then(resp => {
...
export default injectIntl(WithLoandingPanel(PermanenciaVehiculoIndexPage));
