...
const DivisionModuloJobEditPage = props => {
    const { intl } = props;
    ...
    function grabar(e) {
        ...
        if (result.isValid) {
            if (props.dataRowEditNew.esNuevoRegistro) {
                props.agregarJobModulo(props.dataRowEditNew);
            } else {
                props.actualizarJobModulo(props.dataRowEditNew);
            }
        }
    }
            ...
            <PortletBody >
                ...
                <Form formData={props.dataRowEditNew} validationGroup="FormEdicion">
                    <GroupItem itemType="group" colCount={2} colSpan={2}>
                        ...
                        <Item dataField="IdJob" visible={false} ></Item>
...
export default injectIntl(DivisionModuloJobEditPage);
