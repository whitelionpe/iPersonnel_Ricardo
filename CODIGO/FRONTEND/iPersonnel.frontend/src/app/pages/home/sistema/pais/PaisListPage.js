        ...
        <>
            ...
            <PortletBody>
                ...
                >
                    ...
                    <Column dataField="IdPais" caption={intl.formatMessage({ id: "COMMON.CODE" })} width={"20%"} alignment={"center"} />
                    <Column dataField="Pais" caption={intl.formatMessage({ id: "SYSTEM.COUNTRY" })} width={"70%"} />
...
export default injectIntl(PaisListPage);
