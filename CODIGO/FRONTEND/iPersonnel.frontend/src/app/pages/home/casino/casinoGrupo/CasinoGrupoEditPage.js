...
import { obtenerTodos as obtenerCmbTipo } from "../../../../api/casino/casinoTipo.api";

import { listarEstadoSimple, PatterRuler } from "../../../../../_metronic";
import { isRequired, isModified } from "../../../../../_metronic/utils/securityUtils";


const CasinoGrupoEditPage = props => {
  ...
  function grabar(e) {
    ...
    if (result.isValid) {
      if (props.dataRowEditNew.esNuevoRegistro) {
        props.agregarCasinoGrupo(props.dataRowEditNew);
      } else {
        props.actualizarCasinoGrupo(props.dataRowEditNew);
      }
    }
  }
...
export default injectIntl(CasinoGrupoEditPage);
