...
import { rpt_001_ConsumoComedores as loadUrl } from '../../../../../api/casino/reporte.api';
    ...
    return (
      <>
        ...
        >
          ...
          <Column
            dataField="FechaProcesoConsumo"
            caption={intl.formatMessage({ id: "CASINO.REPORT.RESULT.CONSUMPTIOM.SCHEDULED_DATE" })}
            dataType="date"
            format="dd/MM/yyyy"
            alignment={"center"}
            allowHeaderFiltering={false}
          ...
          <Column
            dataField="Cantidad"
            caption={intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.CANTIDAD" })}
            allowHeaderFiltering={false}
            allowSorting={true}
            width={"80px"}
            alignment={"center"}
          />
          <Column
            dataField="CostoAsumidoEmpresa"
            caption={intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.COSTOEMPLEADO" })}
            allowHeaderFiltering={false}
            allowSorting={true}
            width={"100px"}
            alignment={"center"}
          ...
          <Column
            dataField="CostoAsumidoTrabajador"
            caption={intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.COSTOCOMPANIA" })}
            allowHeaderFiltering={false}
            allowSorting={true}
            width={"80px"}
            alignment={"center"}
          ...
          <Summary>
            ...
            <TotalItem
              cssClass="classColorPaginador_"
              column="CostoAsumidoEmpresa"
              summaryType="sum"
              displayFormat={" {0}"}
            />
            <TotalItem
              cssClass="classColorPaginador_"
              column="CostoAsumidoTrabajador"
              summaryType="sum"
              displayFormat={" {0}"}
            />
          </Summary>
