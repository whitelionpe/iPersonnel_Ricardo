...
const CasinoGrupoCompaniaListPage = props => {
            ...
            <PortletBody>
                ...
                >
                   <Editing
                        ...
                        texts={textEditing}
                    /> 
                    <Column dataField="Compania"  caption={intl.formatMessage({ id: "CONFIG.MENU.ASISTENCIA.COMPAÑÍA" })}/>
...
export default injectIntl(CasinoGrupoCompaniaListPage);
