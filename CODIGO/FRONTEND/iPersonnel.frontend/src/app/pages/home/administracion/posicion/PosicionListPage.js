...
import { initialFilter } from "./PosicionIndexPage";


const PosicionListPage = (props) => {

  console.log('carga lista de posiciones',props);
    ...
    return (
      ...
      >
        ...
        <Column
          ...
          caption={intl.formatMessage({ id: "ADMINISTRATION.POSITION.REPORT" })}
