...
import ContratistaPosicionListPage from "./ContratistaPosicionListPage";
import ContratistaPosicionEditPage from "./ContratistaPosicionEditPage";
...
const ContratistaPosicionIndexPage = (props) => {
  ...
  const tabContent_PosicionListPage = () => {
    return <ContratistaPosicionListPage
      ...
      uniqueId={"IndexContratistaPosicionesList"}
  ...
  return (
    <>
      <TabNavContainer
        ...
        submenu={intl.formatMessage({ id: "ADMINISTRATION.POSITION.SUBMENU" }) + ' / ' + intl.formatMessage({ id: "CONFIG.MENU.ADMINISTRACION.CONTRATISTAS_O_TERCEROS" })}
...
export default injectIntl(WithLoandingPanel(ContratistaPosicionIndexPage));
