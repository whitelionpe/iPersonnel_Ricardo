        ...
        <>
            ...
            <PortletBody>
                ...
                >
                    ...
                    <Column dataField="IdMarca" caption={intl.formatMessage({ id: "COMMON.CODE" })} width={"20%"}/>
                    <Column dataField="Marca" caption={intl.formatMessage({ id: "ADMINISTRATION.BRAND.BRAND" })} width={"70%"} />
