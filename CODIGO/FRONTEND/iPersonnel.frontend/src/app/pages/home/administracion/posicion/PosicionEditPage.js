...
const PosicionEditPage = (props) => {
  ...
  console.log("PosicionEditPage|settingDataField:",settingDataField);
  ...
  async function cargarCombos() {
    ...
    //Listar Funciones
    await obtenerCmbFuncion({ IdCliente, Contratista: 'N' }).then(cmbFuncion => {
          ...
          <Form formData={props.dataRowEditNew} validationGroup="FormEdicion">
            <GroupItem itemType="group" colCount={2} colSpan={2}>
              ...
              <Item
                ...
                isRequired={modoEdicion ? isRequired('PosicionPadre', settingDataField) : false}
                editorOptions={{
                  readOnly: true,
                  hoverStateEnabled: false,
                  inputAttr: { 'style': 'text-transform: uppercase' },
                  ...
                  buttons: [{
                    ...
                    options: {
                      ...
                      onClick: () => {
                        const { IdDivision, IdUnidadOrganizativa, IdFuncion, IdTipoPosicion } = props.dataRowEditNew;
                        ...
                        setFiltroLocal({ IdDivision, IdUnidadOrganizativa, IdFuncion, IdTipoPosicion });
              ...
              />
                ...
                <Item
                    ...
                    editorType="dxSelectBox"
                    isRequired={modoEdicion ? isRequired('JefeUnidadOrganizativa', settingDataField) : false}
                    colSpan={2}
                    editorOptions={{
                      items: listarEstado(),
                      valueExpr: "Valor",
                      displayExpr: "Descripcion",
                      readOnly: !(modoEdicion ? isModified('JefeUnidadOrganizativa', settingDataField) : false),
                    }}
                  />
            ...
            <GroupItem itemType="group" colCount={2} colSpan={2}>
              <GroupItem cssClass={"card"} >
                ...
                <Item
                  ...
                  isRequired={modoEdicion ? isRequired('Fiscalizable', settingDataField) : false}
                  label={{
                    text: "Check",
                    visible: false
                  }}
                  ...
                  editorOptions={{
                    value:
                      ...
                      readOnly: !(modoEdicion ? isModified('Fiscalizable', settingDataField) : false),
                ...
                <Item
                  dataField="Confianza"
                  isRequired={modoEdicion ? isRequired('Confianza', settingDataField) : false}
                  label={{
                    text: "Check",
                    visible: false
                  }}
                  ...
                  editorOptions={{
                    ...
                    readOnly: !(modoEdicion ? isModified('Confianza', settingDataField) : false),
