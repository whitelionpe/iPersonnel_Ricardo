...
const PersonaCaracteristicaListPage = props => {
    ...
    const eliminarRegistro = evt => {
      console.log("PersonaCaracteristicaListPage|eliminarRegistro:",evt);
        evt.cancel = true;
...
PersonaCaracteristicaListPage.propTypes = {
    showHeaderInformation: PropTypes.bool,
};
PersonaCaracteristicaListPage.defaultProps = {
    showHeaderInformation: true,
};

export default injectIntl(PersonaCaracteristicaListPage);
