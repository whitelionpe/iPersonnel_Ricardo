                    ...
                    <Form formData={props.dataRowEditNew} validationGroup="FormEdicion" >
                        <GroupItem itemType="group" colCount={2} colSpan={2}>
                            ...
                            <Item dataField="Marca"
                                ...
                                isRequired={modoEdicion ? isRequired('Marca', settingDataField) : false}
                                editorOptions={{
                                    readOnly: !(modoEdicion ? isModified('Marca', settingDataField) : false),
                                    maxLength: 50,
                                    inputAttr: { 'style': 'text-transform: uppercase' },

                                }}
                                >
                                {(isRequiredRule("Marca")) ? <RequiredRule message={intl.formatMessage({ id: "COMMON.ISREQUIERD" })} /> : <StringLengthRule max={50} />}
