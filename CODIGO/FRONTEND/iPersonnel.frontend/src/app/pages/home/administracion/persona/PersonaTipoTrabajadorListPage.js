...
const textEditing = {
    confirmDeleteMessage: "¿Seguro de eliminar tipo trabajador?",
    editRow: "Editar tipo trabajador",
    deleteRow: "Eliminar tipo trabajador",
};

const PersonaTipoTrabajadorListPage = props => {
    ...
    return (
        <>
            <PortletHeader
                title="Listado de Tipo Trabajador"
                toolbar={
                ...
                <React.Fragment>
                    <Form>
                        <GroupItem>
                            <Item>
                                <DataGrid
                                    dataSource={props.personaTipoTrabajadors}
                                    showBorders={true}
                                ...
                                >
                                    ...
                                    <Column dataField="TipoTrabajador" caption="Tipo Trabajador" />
...
export default PersonaTipoTrabajadorListPage;
