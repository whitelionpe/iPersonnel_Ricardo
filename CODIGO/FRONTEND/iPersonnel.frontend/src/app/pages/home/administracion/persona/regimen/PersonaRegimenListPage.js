...
const PersonaRegimenListPage = props => {
            ...
            <PortletBody>
                ...
                >
                    <Editing
                      ...
                      texts={textEditing}
                    />
                    <Column dataField="Regimen" caption={intl.formatMessage({ id: "ADMINISTRATION.PERSON.REGIME.REGIME" })} width={"30%"} />
                    <Column dataField="Guardia" caption={intl.formatMessage({ id: "ADMINISTRATION.PERSON.REGIME.GUARD" })} width={"20%"} />
...
PersonaRegimenListPage.propTypes = {
    showHeaderInformation: PropTypes.bool,
};
PersonaRegimenListPage.defaultProps = {
    showHeaderInformation: true,
};

export default injectIntl(PersonaRegimenListPage);
