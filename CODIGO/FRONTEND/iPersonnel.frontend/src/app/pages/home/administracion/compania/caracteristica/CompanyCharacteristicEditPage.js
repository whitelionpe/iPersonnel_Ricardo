...
const CompanyCharacteristicEditPage = props => {

  const { intl, modoEdicion,  accessButton, setLoading, dataRowEditNew } = props;
  ...
  async function cargarCombos() {
    ...
    setLoading(true);
    let caracteristica = await obtenerTodosCaracteristica({ IdCliente: perfil.IdCliente, IdEntidad: 'C' });
...
export default injectIntl(WithLoandingPanel(CompanyCharacteristicEditPage));
