...
import { obtenerSolicitudActualizacionVehiculo, serviceSolicitud } from "../../../../../../../api/acreditacion/solicitud.api"
...
const DetalleIndexPage = (props) => {
    ...
    const seleccionarRegistro = async (data) => {
        ...
        await Promise.all([
            obtenerSolicitudActualizacionVehiculo({ IdSolicitud: data.IdSolicitud })
        ]).then(resp => {
