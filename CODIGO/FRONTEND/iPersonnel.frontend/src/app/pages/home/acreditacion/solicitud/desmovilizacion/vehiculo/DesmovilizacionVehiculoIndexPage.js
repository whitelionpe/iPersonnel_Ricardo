...
import DesmovilizacionVehiculoListPage from "./DesmovilizacionVehiculoListPage";
export const initialFilter = {
  IdCliente: '',
  Activo: 'S',
};

const DesmovilizacionVehiculoIndexPage = (props) => {
  ...
  const tabContent_DesmovilizacionVehiculListPage = () => {
    return <DesmovilizacionVehiculoListPage
      titulo={titulo}
      ...
      showButtons={false}
      uniqueId={"acreditacionDesmovilizacionVehiculoList"}
      //=>..CustomerDataGrid
  ...
  const tabContent_DetalleIndexPage = () => {
    return <>
      <DetalleIndexPage
  ...
  return (
    <>
      <TabNavContainer
        ...
        componentTabsBody={
          [
            tabContent_DesmovilizacionVehiculListPage(),
            tabContent_DetalleIndexPage()
          ]
        }
      />
...
export default injectIntl(WithLoandingPanel(DesmovilizacionVehiculoIndexPage));
