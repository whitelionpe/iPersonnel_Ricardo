...
import ResultadoAutorizadoresListPage from "../r002_ResultadoAutorizaciones/ResultadoAutorizadoresListPage";

const ResultadoAutorizadoresIndexPage = (props) => {
    ...
    async function listarResultadoAutorizadores() {
        ...
        await serviceReporte.r002ResultadosAutorizador({
           ...
           FechaFin : isNotEmpty(FechaFin) ?  dateFormat(FechaFin, 'yyyyMMdd') : "20211230",
            ...
            console.log("listarResultadoAutorizadores|data:",data);
            setResultadoAutorizadores(data[0]);
            setDataEstadisticoAutorizadores(data[1]);
            // changeTabIndex(0);
        }).catch(err => {
            handleErrorMessages(intl.formatMessage({ id: "MESSAGES.INFO" }), err)
        }).finally(() => { setLoading(false); });
                ...
                <div className="col-md-12">
                    ...
                    <Portlet className={classesEncabezado.border}>
                        ...
                        <>
                          ...
                          <ResultadoAutorizadoresListPage
                              dataRowEditNew ={dataRowEditNew}
                              setDataRowEditNew ={setDataRowEditNew}
                              resultadoAutorizadores={resultadoAutorizadores}
                              dataEstadisticoAutorizadores ={dataEstadisticoAutorizadores}
...
export default injectIntl(WithLoandingPanel(ResultadoAutorizadoresIndexPage));
