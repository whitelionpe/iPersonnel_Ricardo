...
const EmpleadosFilterPage = (props) => {
  ...
  const [popupVisibleCentroCosto, setPopupVisibleCentroCosto] = useState(false);
  ...
  const agregarCentroCosto = (dataPopup) => {
    ...
    setPopupVisibleCentroCosto(false);
  };
                ...
                buttons: [
                  {
                    ...
                    options: {
                      ...
                      disabled: false,
                      onClick: () => {
                        setPopupVisibleCentroCosto(true);
                      },
                    },
                  },
                ],
      ...
      <>
        <Form formData={dataRowEditNew} validationGroup="FormEdicion">
          ...
          <Item
            ...
            {/* <Item colSpan={2} dataField="CodigoPlanilla"/> */}
            <Item
  ...
  return (
    ...
    <Fragment>
      ...
      {popupVisibleCentroCosto && (
        <AdministracionCentroCostoBuscar
          selectData={agregarCentroCosto}
          showButton={false}
          showPopup={{ isVisiblePopUp: popupVisibleCentroCosto, setisVisiblePopUp: setPopupVisibleCentroCosto }}
          cancelarEdicion={() => setPopupVisibleCentroCosto(false)}
...
export default injectIntl(WithLoandingPanel(EmpleadosFilterPage));
