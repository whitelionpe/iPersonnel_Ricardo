...
import ResultadoCalculoAsistenciaFilterPage from "./ResultadoCalculoAsistenciaFilterPage";
import { dateFormat, isNotEmpty, getDateOfDay } from "../../../../../../_metronic";
import ResultadoCalculoAsistenciaListPage from "./ResultadoCalculoAsistenciaListPage";

import { exportarResultadoCalculoAsistencia } from "../../../../../api/asistencia/reporte.api"
...
const ResultadoCalculoAsistenciaIndexPage = (props) => {
  ...
  const exportReport = async () => {
    ...
    if (dataGridRef.current.props.dataSource._items.length > 0) {
      ...
      let params = {
        ...
        tituloHoja: intl.formatMessage({ id: "CONFIG.MENU.ASISTENCIA.CALCULO_ASISTENCIA" }),
        nombreHoja: intl.formatMessage({ id: "CONFIG.MENU.ASISTENCIA.CALCULO_ASISTENCIA" }),
      ...
      await exportarResultadoCalculoAsistencia(params).then(resp => {
    ...
    <>
      ...
      <Portlet>
        ...
        <> 
              ...
              <ResultadoCalculoAsistenciaFilterPage
              ...
              <ResultadoCalculoAsistenciaListPage
                uniqueId={"ResultadoCalculoAsistenciaListPage"}
...
export default injectIntl(WithLoandingPanel(ResultadoCalculoAsistenciaIndexPage));
