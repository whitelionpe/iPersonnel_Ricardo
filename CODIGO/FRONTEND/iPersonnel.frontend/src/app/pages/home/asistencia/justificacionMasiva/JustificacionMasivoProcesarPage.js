...
import JustificacionMasivaFormImportPage from './JustificacionMasivaFormImportPage';

const JustificacionMasivoProcesarPage = (props) => {
    ...
    <Fragment>
      ...
      <PortletBody >
        {nuevaAsignacionImportar ? (
          ...
          <JustificacionMasivaFormImportPage
            titulo={props.titulo}
        ...
        <FieldsetAcreditacion title={intl.formatMessage({ id: "ASSISTANCE.MASSIVE.JUSTIFICATION.DETAIL.PEOPLES" })}>
          ...
          >
            ...
            <Column dataField="IdPersona" caption={intl.formatMessage({ id: "COMMON.CODE" })} width={"9%"} alignment={"Center"} />
            <Column dataField="Documento" caption={intl.formatMessage({ id: "ADMINISTRATION.PERSON.DOCUMENT" })} alignment={"center"} width={"8%"} />
            <Column dataField="NombreCompleto" caption={intl.formatMessage({ id: "ADMINISTRATION.PERSON.FULLNAME" })} width={"15%"} />
            <Column dataField="Justificacion" caption={intl.formatMessage({ id: "ASISTENCIA.PERSONA.BOLSAHORAS.JUSTIFICACION" })} width={"15%"} />
            <Column dataField="FechaInicio" caption={intl.formatMessage({ id: "COMMON.STARTDATE" })} width={"9%"} alignment={"center"}  />
            <Column dataField="FechaFin" caption={intl.formatMessage({ id: "COMMON.ENDDATE" })} width={"9%"} alignment={"center"}  />
            
            <Column dataField="InicioEnfermedad" caption={intl.formatMessage({ id: "ASSISTANCE.PERSON.JUSTIFICATION.DATE.ONSETOFDISEASE" })} width={"9%"} alignment={"center"}  />
            <Column dataField="FinEnfermedad" caption={intl.formatMessage({ id: "ASSISTANCE.PERSON.JUSTIFICATION.DATE.ENDOFSICKNESS" })} width={"9%"} alignment={"center"}  />
            <Column dataField="InicioCertificado" caption={intl.formatMessage({ id: "ASSISTANCE.PERSON.JUSTIFICATION.DATE.HOMECERTIFICATE" })} width={"9%"} alignment={"center"}  />
      ...
      {isVisiblePopUpHorario && (
        <AsistenciaHorarioBuscar
          ...
          uniqueId={"JustificacionMasivoProcesarPage"}
          filtro={filtroLocal}
...
export default injectIntl(WithLoandingPanel(JustificacionMasivoProcesarPage));
