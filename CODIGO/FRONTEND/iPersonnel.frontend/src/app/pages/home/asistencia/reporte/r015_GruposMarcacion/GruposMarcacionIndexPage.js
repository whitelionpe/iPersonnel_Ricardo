...
const GruposMarcacionIndexPage = props => {
    ...
    const generarReporte = async e => {
        ...
        if (result.isValid) {
            ...
            let data = await ListarAsistenciaReporte015ListarPersonaXGrupo(parametros)
                .catch(err => {
    ...
    const exportarReporte = async () => {
        ...
        return {
            ...
            event: ExportarAsistenciaReporte015ListarPersonaXGrupo
        };
    };
...
export default injectIntl(WithLoandingPanel(GruposMarcacionIndexPage));
