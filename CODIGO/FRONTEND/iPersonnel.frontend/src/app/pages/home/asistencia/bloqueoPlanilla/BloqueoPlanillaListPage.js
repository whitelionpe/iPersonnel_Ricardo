...
const BloqueoPlanillaListPage = props => {
            ...
            <PortletBody>
                ...
                >
                    {/* <Editing
                        ...
                        texts={textEditing}
                    /> */}
                    <Column dataField="IdCierrePlanilla" caption={intl.formatMessage({ id: "ACCESS.GROUP.RESTRICTION.CODE" })} width={"15%"} alignment={"center"} 
                    sortOrder="desc"/>
                    <Column dataField="FechaCierrePlanilla" caption={intl.formatMessage({ id: "SECURITY.USER.DATELOCKED" })} width={"25%"} dataType="date" format="dd/MM/yyyy" alignment={"center"} /> 
                    <Column dataField="Activo" caption={intl.formatMessage({ id: "COMMON.ACTIVE" })}  width={"15%"}  alignment={"center"}/>
                    
                    <Column dataField="IdUsuarioCreacion" caption={intl.formatMessage({ id: "AUDIT.USERCREATION" })} width={"20%"} alignment={"center"} />
                    <Column dataField="FechaCreacion" caption={intl.formatMessage({ id: "ASISTENCIA.PERSONA.BOLSAHORAS.FECHACREACION" })} width={"25%"} alignment={"center"} dataType="date" format="dd/MM/yyyy HH:mm"/>
                    
                    <Summary>
                        <TotalItem
                            cssClass="classColorPaginador_"
                            column="IdPlanIdCierrePlanillailla"
                            alignment="left"
                            summaryType="count"
...
export default injectIntl(WithLoandingPanel(BloqueoPlanillaListPage));
