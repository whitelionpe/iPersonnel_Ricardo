...
const PersonaEquipoEditPage = props => {
  ...
  function grabar(e) {
    ...
    if (selectedNodos.length > 0) {
       ...
       props.eliminarPersonaEquipo();
       setTimeout(function () {
        props.agregarPersonaEquipo(arrayEquipos);
      }, 500);
                ...
                <AppBar position="static" className={classesEncabezado.secundario}>
                  <Toolbar variant="dense" className={classesEncabezado.toolbar}>
                    <Typography variant="h6" color="inherit" className={classesEncabezado.title}>
                      {intl.formatMessage({ id: "SYSTEM.TEAM.ADD" })}
                    </Typography>
                  </Toolbar>
                </AppBar>
              </Item>
...
PersonaEquipoEditPage.propTypes = {
  showHeaderInformation: PropTypes.bool,
  searchEnabled: PropTypes.bool,
};
PersonaEquipoEditPage.defaultProps = {
