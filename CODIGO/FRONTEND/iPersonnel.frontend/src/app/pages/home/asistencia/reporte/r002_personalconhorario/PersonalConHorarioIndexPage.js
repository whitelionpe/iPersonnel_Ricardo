...
import PersonalConHorarioFilterPage from "./PersonalConHorarioFilterPage";
import { dateFormat, isNotEmpty, getDateOfDay } from "../../../../../../_metronic";
import PersonalConHorarioListPage from "./PersonalConHorarioListPage";

import { exportarPersonalConHorario } from "../../../../../api/asistencia/reporte.api"
...
const PersonalConHorarioIndexPage = (props) => {
  ...
  const exportReport = async () => {
    ...
    if (dataGridRef.current.props.dataSource._items.length > 0) {
      ...
      let params = {
        ...
        tituloHoja: intl.formatMessage({ id: "CONFIG.MENU.ASISTENCIA.HORARIOS_DEL_TRABAJADOR" }),
        nombreHoja: intl.formatMessage({ id: "CONFIG.MENU.ASISTENCIA.HORARIOS_DEL_TRABAJADOR" }),
      ...
      await exportarPersonalConHorario(params).then(resp => {
...
export default injectIntl(WithLoandingPanel(PersonalConHorarioIndexPage));
