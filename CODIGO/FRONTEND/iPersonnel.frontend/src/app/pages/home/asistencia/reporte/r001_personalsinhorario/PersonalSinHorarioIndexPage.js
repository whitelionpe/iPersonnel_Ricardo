...
import PersonalSinHorarioFilterPage from "./PersonalSinHorarioFilterPage";
import { dateFormat, isNotEmpty, getStartAndEndOfMonthByDay } from "../../../../../../_metronic";
import PersonalSinHorarioListPage from "./PersonalSinHorarioListPage";
...
const PersonalSinHorarioIndexPage = (props) => {
...
export default injectIntl(WithLoandingPanel(PersonalSinHorarioIndexPage));
