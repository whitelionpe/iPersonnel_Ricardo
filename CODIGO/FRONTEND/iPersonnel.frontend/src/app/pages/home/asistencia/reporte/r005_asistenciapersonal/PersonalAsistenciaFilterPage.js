...
const PersonalAsistencialFilterPage = (props) => {
    ...
    <Fragment>
      ...
      {popupVisiblePersonas && (
        <AsistenciaPersonaBuscarReporte
          ...
          selectionMode={"multiple"}
          uniqueId={"ReporteAsistencia_AsistenciaPersonaBuscar"}
...
export default injectIntl(WithLoandingPanel(PersonalAsistencialFilterPage));
