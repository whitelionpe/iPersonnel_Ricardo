...
const HorarioMasivoProcesarPage = (props) => {
  ...
  return (
    <Fragment>
      ...
      <PortletBody >
        ...
        <FieldsetAcreditacion title={intl.formatMessage({ id: "ASSISTANCE.MASSIVE.SCHEDULES.DETAIL.PEOPLES" })}>
        ...
        >
          ...
          <Column dataField="Horario" caption={intl.formatMessage({ id: "ASSISTANCE.MASSIVE.SCHEDULES" })} width={"15%"} />
          <Column dataField="FechaInicio" caption={intl.formatMessage({ id: "COMMON.STARTDATE" })} width={"9%"} alignment={"center"} dataType="date" format={"dd/MM/yyyy"} />
          <Column dataField="FechaFin" caption={intl.formatMessage({ id: "COMMON.ENDDATE" })} width={"9%"} alignment={"center"} dataType="date" format={"dd/MM/yyyy"} />
          <Column dataField="DiaInicio" caption={intl.formatMessage({ id: "ASSISTANCE.SCHEDULE.START.DAY" })} width={"9%"} />
      ...
      {isVisiblePopUpHorario && (
        <AsistenciaHorarioBuscar
          ...
          uniqueId={"HorarioMasivoProcesarPage"}
          filtro={filtroLocal}
...
export default injectIntl(WithLoandingPanel(HorarioMasivoProcesarPage));
