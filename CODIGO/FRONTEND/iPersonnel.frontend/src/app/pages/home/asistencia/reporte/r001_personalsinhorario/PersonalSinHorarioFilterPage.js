...
const PersonalSinHorarioFilterPage = (props) => {
          ...
          <GroupItem itemType="group" colCount={2} >
            ...
            <Item
              ...
              editorOptions={{
                ...
                onValueChanged: (e) => props.setDataRowEditNew({...dataRowEditNew, FechaInicio: e.value})
...
export default injectIntl(WithLoandingPanel(PersonalSinHorarioFilterPage));
