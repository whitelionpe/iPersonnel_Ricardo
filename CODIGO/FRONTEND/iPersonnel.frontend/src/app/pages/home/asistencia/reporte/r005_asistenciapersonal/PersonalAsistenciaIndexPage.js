...
import PersonalAsistenciaFilterPage from "./PersonalAsistenciaFilterPage";
import { dateFormat, isNotEmpty, getDateOfDay } from "../../../../../../_metronic";
import PersonalAsistenciaListPage from "./PersonalAsistenciaListPage";

import { exportarPersonalAsistencia } from "../../../../../api/asistencia/reporte.api"
...
const PersonalAsistenciaIndexPage = (props) => {
  ...
  const exportReport = async () => {
    ...
    if (dataGridRef.current.props.dataSource._items.length > 0) {
      ...
      let params = {
        ...
        tituloHoja: intl.formatMessage({ id: "CONFIG.MENU.ASISTENCIA.ASISTENCIA_PERSONAL" }),
        nombreHoja: intl.formatMessage({ id: "CONFIG.MENU.ASISTENCIA.ASISTENCIA_PERSONAL" }),
      ...
      await exportarPersonalAsistencia(params).then(resp => {
...
export default injectIntl(WithLoandingPanel(PersonalAsistenciaIndexPage));
