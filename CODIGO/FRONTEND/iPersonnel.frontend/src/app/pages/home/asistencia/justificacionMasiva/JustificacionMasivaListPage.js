      ...
      <PortletBody>
        ...
        >
          <Editing
            ...
            texts={textEditing}
          /> 
          <Column dataField="IdProceso" caption={intl.formatMessage({ id: "SYSTEM.PROCESS" })} alignment={"center"} width={"10%"} allowSorting={false} />
          ...
          {/* <Column dataField="Justificacion" caption={intl.formatMessage({ id: "ASISTENCIA.PERSONA.BOLSAHORAS.JUSTIFICACION" })} alignment={"left"} allowSorting={false} /> */}
