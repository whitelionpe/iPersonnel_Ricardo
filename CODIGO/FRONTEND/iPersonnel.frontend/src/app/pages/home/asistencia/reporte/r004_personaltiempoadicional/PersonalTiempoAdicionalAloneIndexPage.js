...
import { exportarPersonalTiempoAdicional, personalTiempoAdicional } from '../../../../../api/asistencia/reporte.api';
...
const PersonalTiempoAdicionalAloneIndex = (props) => {
  ...
  const columnasEstaticas = [
    ...
    },    
    {
      ...
      caption: intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.TOTAL" }) + " " + intl.formatMessage({ id: "ASISTENCIA.PERSONA.BOLSAHORAS.TIEMPOPAGADO" }),
      width: 130,
      alignment: "center"
    },
    {
      dataField: "TotalCompensados",
      caption: intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.TOTAL" }) + " " + intl.formatMessage({ id: "ASISTENCIA.PERSONA.BOLSAHORAS.TIEMPOCOMPENSADO" }),
      width: 150,
      alignment: "center"
    },
    {
      dataField: "TotalExcluidos",
      caption: intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.TOTAL" }) + " " + intl.formatMessage({ id: "ASISTENCIA.PERSONA.BOLSAHORAS.TIEMPOEXCLUIDO" }),
      width: 150,
      alignment: "center"
    },
    {
      dataField: "TotalSolicitudAprobada",
      caption: intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.TOTAL" }) + " " + intl.formatMessage({ id: "COMMON.APPROVED" }),
      width: 120,
      alignment: "center"
    },
    {
      dataField: "TotalSolicitudPendiente",
      caption: intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.TOTAL" }) + " " + intl.formatMessage({ id: "COMMON.EARRING" }),
      width: 120,
      alignment: "center"
    },
    {
      dataField: "TotalSolicitudRechazada",
      caption: intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.TOTAL" }) + " " + intl.formatMessage({ id: "COMMON.REJECTED" }),
      width: 120,
      alignment: "center"
    },
    {
      dataField: "TotalSinSolicitud",
      caption: intl.formatMessage({ id: "CASINO.CONSOLIDATED.REPORT.TOTAL" }) + " " + intl.formatMessage({ id: "COMMON.NO.REQUEST" }),
      width: 130,
      alignment: "center"
    },
    {
  ...
  const columnasEstaticasDetail = [
    ...
    // },
    {
      dataField: "SolicitudPendiente",
      caption: intl.formatMessage({ id: "COMMON.EARRING" }),
      width: 120,
      alignment: "center"
    },
    {
      dataField: "SolicitudRechazada",
      caption: intl.formatMessage({ id: "COMMON.REJECTED" }),
      width: 120,
      alignment: "center"
    },
    {
      dataField: "SinSolicitud",
      caption: intl.formatMessage({ id: "COMMON.NO.REQUEST" }),
      width: 130,
      alignment: "center"
    },
    {
  ...
  const consultaInforme = async (skip, take, listarResumen = "S", documento = "") => {
    ...
    let datos = await personalTiempoAdicional(params)
      .catch(err => {
  ...
  const exportExcel = async () => {
    ...
    if (dataGridRef.current.props.dataSource.length > 0) {
      ...
      setLoading(true);
      await exportarPersonalTiempoAdicional(params).then(response => {
    ...
    return (
      <>
        <Form formData={dataRowEditNew} validationGroup="FormEdicion">
          ...
          <Item dataField="TrabajadorHorasExtra"              
              label={{ text: "Check", visible: false }}
              editorType="dxCheckBox"
              colSpan={2}
              editorOptions={{
                text: intl.formatMessage({ id: "CASINO.SHOW.OVERTIME.WORKER" }),
                width: "100%",
...
export default injectIntl(WithLoandingPanel(PersonalTiempoAdicionalAloneIndex));
