...
const JustificacionMasivaCancellationPage = props => {
    ...
    const cancelarJustificacion =() =>{
        props.grabarCancelacionJustificacion(selectedRow);
        ...
        <>
                        ...
                        toolbar={
                            <PortletHeaderToolbar>
                                <Button
                                    ...
                                    onClick={props.buscarJustificacionCancelacion}
                                ...
                                <Button
                                    ...
                                    hint={intl.formatMessage({ id: "ACCREDITATION.REQUEST.BUTTON.GRID.CANCEL" }) + " "
                                        + intl.formatMessage({ id: "CONFIG.MENU.ASSISTANCE.REPORT_JUSTIFICATION" })}
            ...
            <PortletBody>
                ...
                >
                    ...
                    <Column dataField="FechaInicio" caption={intl.formatMessage({ id: "COMMON.STARTDATE" })} width={"10%"} dataType="date" format="dd/MM/yyyy" alignment={"center"} />
                    <Column dataField="FechaFin" caption={intl.formatMessage({ id: "COMMON.ENDDATE" })} width={"10%"} dataType="date" format="dd/MM/yyyy" alignment={"center"} />
                    ...
                    <Column dataField="Estado" caption={intl.formatMessage({ id: "COMMON.STATE" })} width={"10%"} alignment={"center"} />
                    <Column dataField="IdProceso" caption={intl.formatMessage({ id: "SYSTEM.PROCESS" })} width={"10%"} alignment={"center"} />
...
export default injectIntl(WithLoandingPanel(JustificacionMasivaCancellationPage));
