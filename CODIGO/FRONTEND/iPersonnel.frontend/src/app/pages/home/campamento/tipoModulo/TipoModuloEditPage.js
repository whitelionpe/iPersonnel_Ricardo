...
const TipoModuloEditPage = props => {
  ...
  function grabar(e) {
    ...
    if (result.isValid) {
      if (props.dataRowEditNew.esNuevoRegistro) {
        props.agregarTipoModulo(props.dataRowEditNew);
      } else {
        props.actualizarTipoModulo(props.dataRowEditNew);
      }
    }
  }
            ...
            <GroupItem itemType="group" colCount={2} colSpan={2}>
              ...
              <Item dataField="TipoModulo"
                ...
                editorOptions={{
                  maxLength: 100,
                  inputAttr: { 'style': 'text-transform: uppercase' },
                  readOnly: !(modoEdicion ? isModified('TipoModulo', settingDataField) : false),
                }}
              >
...
export default injectIntl(TipoModuloEditPage);
