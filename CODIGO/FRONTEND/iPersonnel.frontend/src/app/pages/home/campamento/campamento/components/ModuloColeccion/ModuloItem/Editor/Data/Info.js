...
const ModuloItemEditorDataInfo = ({
  item,
  mostrarEditor,
  intl,
}) => {
  const { IdModulo, Modulo, TipoModulo, Habitacion } = item;
          ...
          <div className="kt-widget1__header mr-3">
            ...
            <div className="buttons-header">
              <Button
                ...
                type="normal"
                stylingMode="text"
                visible={!!!Habitacion && !!!item.SectionType}
...
export default injectIntl(ModuloItemEditorDataInfo);
