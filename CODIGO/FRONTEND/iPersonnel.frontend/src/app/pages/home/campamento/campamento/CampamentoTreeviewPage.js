...
import { listarTreeView } from "../../../../api/campamento/campamento.api";
...
const CampamentoTreeViewPage = (props) => {
    ...
    const listar = async () => {
        const { IdCliente, IdDivision, IdCampamento } = data;
        const params = {
            idCliente: IdCliente,
    ...
    const seleccionarNodo = (selectedNode) => {
        if (!timeout) {
            ...
            if (selectedNode.Nivel === 0 || selectedNode.Nivel === 3) return;
            if (seleccionado === selectedNode) {
                props.cambiarTab(selectedNode, "campamento");
            }
        }
    }
                                ...
                                <fieldset className="scheduler-border">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <i className="fas fa-city" />: {intl.formatMessage({ id: "CAMP.RESERVATION.MODULE" })}
                                        </div>
                                        <div className="col-12">
...
export default injectIntl(WithLoandingPanel(CampamentoTreeViewPage));