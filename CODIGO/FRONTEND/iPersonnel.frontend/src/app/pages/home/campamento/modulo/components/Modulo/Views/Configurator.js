...
import { isArray, isFunction, isNullOrUndefined, isObject, isSet } from "../../../../../../../partials/shared/CommonHelper";
...
const Configurator = ({
  ...
  const renderHeader = () => {
    ...
    return (
      <Grid fluid className="modulo-config-acc">
        <Row middle="xs" between="xs">
          ...
          <Col xsOffset={6} xs={2} className="border-l">
            <div className="modulo-config-acc-btns">
  ...
  const render = () => {
    return (
      <LayoutView data={itemData}
        layoutCssClass="modulo-configurator"
