          ...
          <Form formData={props.dataRowEditNew} validationGroup="FormEdicion" >
            <GroupItem itemType="group" colCount={2} colSpan={2}>
              ...
              <Item dataField="Licencia"
                label={{ text: intl.formatMessage({ id: "IDENTIFICATION.LICENSE.LICENSE" }) }}
                ...
                >
                {(isRequiredRule("Licencia")) ? <RequiredRule message={intl.formatMessage({ id: "COMMON.ISREQUIERD" })} /> : <StringLengthRule max={50} />}
