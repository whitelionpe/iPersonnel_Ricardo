        ...
        <>
            ...
            <PortletBody>
                ...
                >
                    ...
                    <Column dataField="IdLicencia" caption={intl.formatMessage({ id: "COMMON.CODE" })} width={"20%"} alignment={"center"}/>
                    <Column dataField="Licencia" caption={intl.formatMessage({ id: "IDENTIFICATION.LICENSE.LICENSE" })} width={"70%"} />
