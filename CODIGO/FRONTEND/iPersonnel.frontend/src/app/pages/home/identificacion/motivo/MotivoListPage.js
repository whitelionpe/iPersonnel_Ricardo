        ...
        <>
            ...
            <PortletBody>
                ...
                >
                    ...
                    <Column dataField="IdMotivo" caption={intl.formatMessage({ id: "COMMON.CODE" })}   width={"20%"} alignment={"center"}  />
                    <Column dataField="Motivo" caption={intl.formatMessage({ id: "COMMON.DESCRIPTION" })} width={"70%"}  />
...
export default injectIntl(MotivoListPage);
