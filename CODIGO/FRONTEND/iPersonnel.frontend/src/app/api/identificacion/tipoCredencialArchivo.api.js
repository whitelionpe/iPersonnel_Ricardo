...
export const URL = Constants.API_URL + "/api/IdentificacionTipoCredencialArchivo";

export const serviceTipoCredencialArchivo = {
  ...
  descargar: (params) => {
    return from(axios.get(`${URL}/descargar`, { params })).pipe(
      map(result => result.data.result)
    ).toPromise();
  },
