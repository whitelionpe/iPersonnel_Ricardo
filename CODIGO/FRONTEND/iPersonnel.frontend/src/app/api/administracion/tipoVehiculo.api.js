...
export const URL = Constants.API_URL + "/api/administraciontipovehiculo";
...
export const serviceTipoVehiculo = {

  obtenerTipoVehiculoLicencia(params) {
    return from(axios.get(`${URL}/obtenerTipoVehiculoLicencia`, { params })).pipe(
      map(result => result.data.result)
    ).toPromise();
  },
