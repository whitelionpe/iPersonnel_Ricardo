...
export const URL = Constants.API_URL + "/api/AdministracionFeriado";


export const serviceFeriado = {
  ...
  migrarFeriados:(params) => {
    return from(axios.put(`${URL}/migrarFeriados`, params)).pipe(
      map(result => result.data.result)
    ).toPromise();
  }
}
