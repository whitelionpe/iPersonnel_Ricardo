...
export const URL = Constants.API_URL + "/api/AdministracionContrato";
...
export function obtenerTodosActivos(params) {
  return from(axios.get(`${URL}/obtenerTodosActivos`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
...
export function exportarPersonasPorContrato(params) {
  return from(axios.get(`${URL}/exportarPersonasPorContrato`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
...
export const storeFiltrar = `${URL}/filtrarcomponente`;

export const storeListarPersonasPorContrato = `${URL}/filtrarPersonasPorContrato`;


export const serviceContrato={
