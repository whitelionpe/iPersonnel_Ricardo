...
export const URL = Constants.API_URL + "/api/AdministracionRegimen";
...
//AHORA YA NO EXISTE, AL MENOS AQUI
// export const storeFiltrarRegimenPersona = `${URL}/filtrarRegimenPersona`; 
