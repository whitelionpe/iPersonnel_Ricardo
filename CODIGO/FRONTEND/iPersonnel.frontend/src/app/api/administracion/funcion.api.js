...
export const URL = Constants.API_URL + "/api/AdministracionFuncion";
...
export function obtenerTodosMandanteContratista(params) {
  return from(axios.get(`${URL}/obtenerTodosMandanteContratista`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
