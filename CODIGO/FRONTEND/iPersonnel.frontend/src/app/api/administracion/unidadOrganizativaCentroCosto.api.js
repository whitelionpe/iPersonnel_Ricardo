...
export const URL = Constants.API_URL + "/api/AdministracionUnidadOrganizativaCentroCosto";
///api/AdministracionUnidadOrganizativaCentroCosto/listar

export const serviceUnidadCentroCosto = {
