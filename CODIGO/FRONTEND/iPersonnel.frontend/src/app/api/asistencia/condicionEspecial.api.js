...
export const URL = Constants.API_URL + "/api/AsistenciaCondicionEspecial";
...
export function obtener(params) {
  ...
  export function ObtenerCondicionEspecialPorCompania(params) {
    return from(axios.get(`${URL}/ObtenerCondicionEspecialPorCompania`, { params })).pipe(
      map(result => result.data.result)
    ).toPromise();
  }
