...
export const URL = Constants.API_URL + "/api/AsistenciaAutorizadorJustificacion";
...
export function obtener(params) {
  ...
  export function listarAutorizadoresJustificacionAsignados(params) {
    return from(axios.get(`${URL}/listarAutorizadoresJustificacionAsignados`, { params })).pipe(
      map(result => result.data.result)
    ).toPromise();
  }
