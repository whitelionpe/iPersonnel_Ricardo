...
export const URL = Constants.API_URL + "/api/sistemadivisionmoduloregla";
...
export function obtenerTodos(numPagina, tamPagina) {
  return from(axios.get(`${URL}/obtenerTodos`, { numPagina, tamPagina })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
