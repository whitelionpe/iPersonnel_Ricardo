...
export const URL = Constants.API_URL + "/api/sistemalicencia";
...
export function validarUsoLicencia(params) {
  return from(axios.get(`${URL}/validarUsoLicencia`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}