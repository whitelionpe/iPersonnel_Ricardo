...
export const URL = Constants.API_URL + "/api/sistemaequipomantenimiento";
...
export function eliminarxtipo(params) {
  return from(axios.delete(`${URL}/eliminarxtipo`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
