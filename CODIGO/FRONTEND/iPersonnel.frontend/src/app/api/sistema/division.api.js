...
export const URL = Constants.API_URL + "/api/SistemaDivision";
...
export function ObtenerTodosClientePadre(params) {
  return from(axios.get(`${URL}/ObtenerTodosClientePadre`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
