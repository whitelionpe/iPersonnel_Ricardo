...
export const URL = Constants.API_URL + "/api/acreditaciondatoevaluar";
...
export function listarDatoEvaluarPersonas(params) {
  return from(axios.get(`${URL}/listarDatoEvaluarPersonas`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
