...
export const URL = Constants.API_URL + "/api/SeguridadPerfilCaracteristica";
...
export function obtenerPorUsuario(params) {
...
//     return from(axios.get(`${URL}/listarCaracteristicas`, {})).pipe(
//       map(result => result.data.result)
//     ).toPromise();
//   }
