...
export const URL = Constants.API_URL + "/api/SeguridadUsuarioCompania";
...
export function obtenerUsuarioCompania(params) {
  return from(axios.get(`${URL}/obtenerUsuarioCompania`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}
