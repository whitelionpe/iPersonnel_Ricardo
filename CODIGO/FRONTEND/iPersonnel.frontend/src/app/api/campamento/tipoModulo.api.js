...
export const URL = Constants.API_URL + "/api/CampamentoTipoModulo";
...
export function listarTipoModuloPorCampamento(params) {
  return from(axios.get(`${URL}/listarTipoModuloPorCampamento`, { params })).pipe(
    map(result => result.data.result)
  ).toPromise();
}