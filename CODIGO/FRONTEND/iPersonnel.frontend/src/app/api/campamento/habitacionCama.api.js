...
export const URL = Constants.API_URL + "/api/campamentoHabitacionCama";
...
export function filtrar(params) {
  return from(axios.get(`${URL}/filtrar`, { params })).pipe(map(({ data }) => data)).toPromise();
}