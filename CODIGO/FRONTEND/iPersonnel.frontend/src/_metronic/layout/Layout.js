...
import { ScreenLockContext } from '../../app/context/ScreenLockContext';
const styles = [];
    ...
    return selfLayout !== "blank" ? (
        ...
        >
            ...
            <div
                ...
                onMouseOver={() => { setCountTime(0); }}
                onMouseMove={() => { setCountTime(0); }}
                onScroll={() => { setCountTime(0); }}
            ...
            >
                <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
                    <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                        ...
                        >
                            {asideDisplay ? (
                                <div className={`kt-container ${contentContainerClasses} kt-grid kt-grid--ver`}>
                                    <AsideLeft />
                                    <div
                                    ...
                                    >
                                        {subheaderDisplay && <SubHeader />}
                                        <div>&nbsp;</div>
                                        {contentExtended ? { children } : <KtContent>{children}</KtContent>}
                                    </div>
                                )}
                            {/*<!-- end:: Content Body -->*/}
                        </div>
