  ...
  componentDidMount() {
    ...
    if (
      ...
      objectPath.set(options, "minimize", {
        ...
        // },//COMENTADO: JDELVILLAR: 2020-07-06
        mobile: {
          on: "kt-header--minimize"
        }
      });
      ...
      >
        ...
        <div className="kt-header__top">
          <div className={`kt-container ${headerContainerClasses}`}>
            <Brand className="align-self-start" />
          </div>
        </div>           
         
        {/* SIDER */}
        <div className={`kt-container ${headerContainerClasses}`} style={{  
          backgroundImage: `url(${toAbsoluteUrl("/template_01/assets/images/header/ipersonnel_header_inferior.jpg")})` ,
