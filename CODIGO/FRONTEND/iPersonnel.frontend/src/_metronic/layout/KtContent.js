...
function KtContent({ children, contentContainerClasses }) {
  ...
  return <div className={cssClassesState.join(" ")} style={{backgroundSize: 'cover',backgroundImage: `url(${toAbsoluteUrl("/template_01/assets/images/background/bg_home_02.jpg")})`}}>{children}</div>;
}
